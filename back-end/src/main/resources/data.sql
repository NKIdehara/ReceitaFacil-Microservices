INSERT INTO tbl_receitas (usuario, nome, preparo, figura, create_date) VALUES
   ...
   ('nOCEzyRcfXN3UqtSlfyrqzgsOKL2', 'Macarrao', 'Cozinhar o macarrao; escorrer e colocar o molho.', 'https://firebasestorage.googleapis.com/v0/b/infnet-receitafacil.appspot.com/o/ic_food_3.png?alt=media&token=47038466-478b-423a-8e11-5c74f88f4d2a', SELECT CURRENT_DATE());
